...
void CGridSceneNode::SGrid::setDefaultMaterial()
{
    ...
    MeshBuffer->getMaterial().ZWriteEnable = irr::video::EZW_ON;
...
{
	video::S3DVertex* vertices = (video::S3DVertex*)MeshBuffer->getVertexBuffer().pointer();
...
void CGridSceneNode::rebuildSelectionMesh()
{
	...
	irr::video::S3DVertex* vertices = (video::S3DVertex*)SelectionMeshBuffer->getVertexBuffer().pointer();
	for ( int i=0; i<4; ++i )
